...
8. 이전 대화 컨텍스트를 고려하여 연속적인 대화 흐름을 유지하세요.
...
5. **컨텍스트 활용**: 이전 대화의 맥락을 고려하여 연속성 있는 태스크를 생성하세요.
...
def create_task_decomposition_prompt(user_query: str, available_roles: str, agents_detail: str = None, conversation_context: str = None) -> str:
    """
    태스크 분해 프롬프트 생성
